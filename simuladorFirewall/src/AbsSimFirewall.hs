...
data Function = Rules [Rule] | Host [Inter] | Packages [Package]
  deriving (Eq, Ord, Show, Read)
...
data Package
    = Tcp IntEstTCP Ip String Ip Integer Integer Integer Integer
    | Udp Ip String Ip Integer Integer Integer
    | Icmp Ip String Ip Integer Integer Integer Integer Integer Integer Integer
  deriving (Eq, Ord, Show, Read)
