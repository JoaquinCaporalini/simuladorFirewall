...
instance Print AbsSimFirewall.Package where
  prt i e = case e of
    AbsSimFirewall.Tcp intesttcp ip1 str ip2 n1 n2 n3 n4 -> prPrec i 0 (concatD [doc (showString "TCP"), doc (showString "state"), prt 0 intesttcp, doc (showString "src"), prt 0 ip1, doc (showString "src-mac"), prt 0 str, doc (showString "dst"), prt 0 ip2, doc (showString "spot"), prt 0 n1, doc (showString "dport"), prt 0 n2, doc (showString "ttl"), prt 0 n3, doc (showString "Use"), prt 0 n4, doc (showString ";")])
    AbsSimFirewall.Udp ip1 str ip2 n1 n2 n3 -> prPrec i 0 (concatD [doc (showString "UDP"), doc (showString "src"), prt 0 ip1, doc (showString "src-mac"), prt 0 str, doc (showString "dst"), prt 0 ip2, doc (showString "spot"), prt 0 n1, doc (showString "dport"), prt 0 n2, doc (showString "Use"), prt 0 n3, doc (showString ";")])
    AbsSimFirewall.Icmp ip1 str ip2 n1 n2 n3 n4 n5 n6 n7 -> prPrec i 0 (concatD [doc (showString "ICMP"), doc (showString "src"), prt 0 ip1, doc (showString "src-mac"), prt 0 str, doc (showString "dst"), prt 0 ip2, doc (showString "stype"), prt 0 n1, doc (showString "scode"), prt 0 n2, doc (showString "sid"), prt 0 n3, doc (showString "dtype"), prt 0 n4, doc (showString "dcode"), prt 0 n5, doc (showString "did"), prt 0 n6, doc (showString "Use"), prt 0 n7, doc (showString ";")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
